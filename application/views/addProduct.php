    ...
    <div class="card-body">
        <div class="table-responsive">
            <div class="container-fluid">
                <form method='post' action="addProduct/save" enctype='multipart/form-data'>
                    <div class="row">
                        <div class="col">
                            <!-- <input type="file" class="filepond" id="filepond" name="filepond[]" multiple data-allow-reorder="true" data-max-file-size="3MB"> -->
                            <input id="drop" name="input-b3[]" type="file" class="file" multiple data-show-upload="false" data-show-caption="true" data-msg-placeholder="Select {files} for upload...">
                        </div>
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="input-group my-3">
                                        ...
                                        <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" id="price" name="price">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="input-group my-3">
                                        ...
                                        <input type="number" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" id="stok" name="stok">
                                    </div>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary btn-md btn-block">Tambah Produk</button>
                        </div>
                    </div>
                </form>
            </div>
